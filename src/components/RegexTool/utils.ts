...
export const darkerHighlightColors = [
  "#B04B28",
  "#B37D21",
  "#BC5180",
  "#748F55",
...
export const regexFlags: Flag[] = [
  ...
  // In the current implementation We always use the d flag in order to be able to colorize the groups correctly. This could of course be turned off if we choose that the user should be able to choose the d flag or not
